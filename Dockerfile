...
RUN \
  ...
  echo "deb http://ppa.launchpad.net/jcfp/ppa/ubuntu focal main" >> /etc/apt/sources.list.d/sabnzbd.list && \
  echo "deb-src http://ppa.launchpad.net/jcfp/ppa/ubuntu focal main" >> /etc/apt/sources.list.d/sabnzbd.list && \

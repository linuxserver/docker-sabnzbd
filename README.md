...
<!-- Please read https://github.com/linuxserver/docker-sabnzbd/blob/unstable/.github/CONTRIBUTING.md -->
...
[![LSIO CI](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=CI&query=CI&url=https%3A%2F%2Fci-tests.linuxserver.io%2Flinuxserver%2Fsabnzbd%2Funstable%2Fci-status.yml)](https://ci-tests.linuxserver.io/linuxserver/sabnzbd/unstable/index.html)
...
Simply pulling `lscr.io/linuxserver/sabnzbd:unstable` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
* Image version number:
    ...
    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/sabnzbd:unstable
    ```
...
* Update the image:
    ...
    ```bash
    docker pull lscr.io/linuxserver/sabnzbd:unstable
    ```
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/sabnzbd:unstable .
```
...
* **16.05.23:** - Rebase unstable to Alpine 3.18, deprecate armhf.
...
* **22.02.22:** - Build unrar from source.

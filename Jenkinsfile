    ...
    stage('Docker-Push-Multi') {
      ...
      steps {
        withCredentials([
          ...
          sh "docker tag ${IMAGE}:arm32v7-${META_TAG} ${IMAGE}:arm32v7-unstable"
          ...
          sh "docker push ${IMAGE}:arm32v7-unstable"
          sh "docker push ${IMAGE}:arm64v8-unstable"
          sh "docker manifest push --purge ${IMAGE}:unstable || :"
          sh "docker manifest create ${IMAGE}:unstable ${IMAGE}:amd64-unstable ${IMAGE}:arm32v7-unstable ${IMAGE}:arm64v8-unstable"
          sh "docker manifest annotate ${IMAGE}:unstable ${IMAGE}:arm32v7-unstable --os linux --arch arm"
